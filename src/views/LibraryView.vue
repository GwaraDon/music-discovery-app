<template>
  <div class="p-8">
    ...
    <div class="py-1.5 flex items-center w-full relative h-full">
      <img width="140" :src="artist.albumCover" />

      <div class="w-full ml-5">
        <div
          class="text-3xl text-white absolute w-full hover:underline cursor-pointer top-0 font-bosemiboldld"
        >
          {{ artist.name }}
        </div>
        ...
        <div class="text-gray-300 text-[13px] flex">
          ...
          <div class="ml-2 flex">
            <div class="w-1 h-1 bg-gray-300 rounded-full mt-2 mr-2" />
    ...
    <div
      class="mt-6 flex items-center justify-between px-5 pt-2 border-b border-b-[#2A2A2A] pb-2 mb-4"
    >
...
const { isPlaying, currentArtist, currentTrack } = storeToRefs(useSong)
